...
This project satisfies the constraints of creating a Daraz-style product listing screen focusing primarily on having *exactly ONE vertical scrollable view* without any scroll conflicts, while maintaining a collateral header, pinned tabs, and side-swipe gestures.
